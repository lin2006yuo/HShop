<template>
    <section class="msite">
        ...
        <div class="msite_icon_list">
            <ul class="list">
                <li class="item"><a href="javascript:;"><img src="./images/shop/food.png" alt=""><span class="text">美食</span></a></li>
                <li class="item"><a href="javascript:;"><img src="./images/shop/food.png" alt=""><span class="text">美食</span></a></li>
                <li class="item"><a href="javascript:;"><img src="./images/shop/food.png" alt=""><span class="text">美食</span></a></li>
                <li class="item"><a href="javascript:;"><img src="./images/shop/food.png" alt=""><span class="text">美食</span></a></li>
                <li class="item"><a href="javascript:;"><img src="./images/shop/food.png" alt=""><span class="text">美食</span></a></li>
        ...
        <div class="msite_recom_list">
            <ul class="list">
                ...
                <li class="item"><a href=""><img src="./images/shop/recom.png" alt=""><div class="wrapper"><h5>名店抢购</h5><p>探鱼炉鱼</p><div clas="desc">69元2-3人餐</div></div></a></li>
                <li class="item"><a href=""><img src="./images/shop/recom.png" alt=""><div class="wrapper"><h5>名店抢购</h5><p>探鱼炉鱼</p><div clas="desc">69元2-3人餐</div></div></a></li>
                <li class="item"><a href=""><img src="./images/shop/recom.png" alt=""><div class="wrapper"><h5>名店抢购</h5><p>探鱼炉鱼</p><div clas="desc">69元2-3人餐</div></div></a></li>
                </div>
            </ul>
        </div>
        <shop-list location="宏安花园"></shop-list>
    </section>
</template>
<script>
